...
function EnhancedTableToolbar(props: EnhancedTableToolbarProps) {
  const { numSelected, title, readonly } = props;
  ...
  return (
    ...
    >
      ...
      {readonly ? null : (
        <IconButton size={"small"} onClick={() => navigate("create")}>
          <Add />
        </IconButton>
      )}
    </Toolbar>
...
export const EnhancedTable = (props: TableProps) => {
  ...
  return (
    <Box sx={{ width: "100%" }}>
      <Paper sx={{ width: "100%", mb: 2 }} elevation={0} variant={"outlined"}>
